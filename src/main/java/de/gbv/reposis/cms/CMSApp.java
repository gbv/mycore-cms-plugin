...
/**
 * Jersey REST Application for the CMS API.
 * This application is registered programmatically by {@link JerseyAPIDeployer}
 * because the plugin JAR is loaded at runtime.
 *
 * @author Sebastian Hofmann
 */
public class CMSApp extends ResourceConfig {
    ...
    /**
     * @return the version of the CMS-API
     */
    ...
    protected String[] getRestPackages() {
        return MCRConfiguration2.getOrThrow("MCR.CMS.API.Resource.Packages", MCRConfiguration2::splitValue)
            .toArray(String[]::new);
    }
}
